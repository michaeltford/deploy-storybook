import{j as t}from"./index-DWKpDUR-.js";import{r as c}from"./iframe-CpXbX42E.js";import{b as v,a as P,s as S}from"./index-C3bn2QFg.js";import"./index-z4VAroti.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fWxn02CS.js";import"./client-Ba8_ROJ4.js";const g=i=>{const{freezeTop:o,freezeLeft:n,...p}=i,s=c.useRef(null),{selection:R,overlay:f,...d}=v({gridRef:s}),m=c.useCallback(r=>{const{key:u,style:y,...z}=r,l=r.range;return t.jsx(P,{...z,style:{...y,color:`${l.rowStart<o||l.colStart<n?"blue":void 0}`},value:`${r.range.rowStart}:${r.range.colStart}`},u)},[o,n]),a={pathProps:{stroke:"blue"}};return t.jsx("div",{className:"storybook-container",children:t.jsx(S,{...p,ref:s,cellRenderer:m,freezeTop:o,freezeLeft:n,freezeLeftProps:a,freezeTopProps:a,onPointerDown:r=>{d.onPointerDown(r)},overlays:[f]})})},e=g.bind({});e.args={columnCount:200,rowCount:200,freezeTop:5,freezeLeft:4};e.storyName="with Frozen Cells";const x={title:"Grid",component:e,parameters:{controls:{sort:"requiredFirst"}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`props => {
  const {
    freezeTop,
    freezeLeft,
    ...rest
