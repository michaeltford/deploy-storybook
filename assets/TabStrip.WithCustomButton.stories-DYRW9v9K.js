import{j as a}from"./index-Be1k0P_l.js";import{r}from"./iframe-CWCjrGPE.js";import{t as T}from"./index-BBX37kc2.js";import{U as g,a as f}from"./index-DaE1w_lX.js";import"./index-D0kf0PFp.js";import"./preload-helper-PPVm8Dsz.js";import"./client-BpSzD-wv.js";import"./index-B3lpE7zk.js";const v=r.memo(r.forwardRef((d,l)=>{const{children:o,style:m,className:c,value:u,editing:b,editable:p,disabled:t,index:n,selectedIndex:e,background:i,activeColor:h,dragging:x,borderColor:I,borderWidth:y,...S}=d;return a.jsx("div",{ref:l,style:{...m,display:"flex",flexDirection:"column",background:e===n?"lightgray":i,minHeight:"0px",fontFamily:"inherit",fontSize:"16px",fontWeight:e===n?"500":"400",lineHeight:"1",letterSpacing:"0px",textTransform:"none",minWidth:"unset",borderBottom:e===n?`${h} solid 2px`:"none",borderLeft:e===n?`${h} solid 2px`:"none",borderRight:e===n?`${h} solid 2px`:"none",borderBottomLeftRadius:e===n?"4px":void 0,borderBottomRightRadius:e===n?"4px":void 0,cursor:x?void 0:"pointer"},...S,children:a.jsx("div",{style:{flex:"1 1 100%",display:"flex",flexDirection:"row"},children:o})})})),C=d=>{const[l,o]=r.useState(0),[m,c]=r.useState(["Sheet 1","Sheet 2","Sheet 3","Sheet 4","Sheet 5"]),u=r.useCallback(t=>{o(t)},[]),b=r.useCallback((t,n)=>{c(e=>{const i=[...e];return i[t]=n,i})},[]),p=r.useCallback((t,n)=>{c(e=>T.arrayMove(e,t,n)),o(e=>t===e?n:t<e&&n<e||t>e&&n>e?e:t<e?e-1:e+1)},[]);return a.jsx("div",{style:{width:"75%",position:"relative"},children:a.jsx(g,{style:{},...d,selectedTabIndex:l,tabNames:m,onSelectedTabIndexChange:u,onTabNameChange:b,onTabMove:p,renderTabButton:t=>a.jsx(v,{...t}),activeColor:new f("red"),propsEditLabel:{renderInput:t=>a.jsx("input",{...t,style:{...t.style,color:"red"}})}})})},s=C.bind({});s.args={disabled:!1};s.storyName="TabStrip with Custom Tabs";const W={title:"TabStrip",component:s};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`props => {
  // const {
  //   showMenuSquare,
  //   ...rest
  // } = props as any;
