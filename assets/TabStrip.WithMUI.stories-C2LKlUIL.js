import{j as a}from"./index-Bex5ZTIz.js";import{r as s}from"./iframe-Bhn-vlEr.js";import{t as p}from"./index-tI__wt30.js";import{P as x}from"./index-CpiIqDFN.js";import{I as g,j as I,B as T,U as v,M as f,e as C,a as B}from"./index-9kA3aVAG.js";import{B as y,I as w}from"./TextField-CibThDkM.js";import"./index-CQih4H26.js";import"./preload-helper-D9Z9MdNV.js";import"./client-BiiePqMP.js";import"./index-Bl98VB8F.js";import"./Tooltip-BCGaakb4.js";const N=o=>{const{...h}=o,[c,l]=s.useState(0),[S,i]=s.useState(["Sheet 1","Sheet 2","Sheet 3","Sheet 4","Sheet 5*","Sheet 6","Sheet a","Sheet b","Sheet c","Sheet d","Sheet e","Sheet f","Sheet g","Sheet h","Sheet i","Sheet j","Sheet k","Sheet l","Sheet m","Sheet n","Sheet o","Sheet p","Sheet q","Sheet r","Sheet s","Sheet t","Sheet u","Sheet v"]),m=s.useCallback(e=>{l(e)},[]),u=s.useCallback((e,r)=>{i(t=>{const d=[...t];return d[e]=r,d})},[]),b=s.useCallback((e,r)=>{i(t=>p.arrayMove(t,e,r)),l(t=>e===t?r:e<t&&r<t||e>t&&r>t?t:e<t?t-1:t+1)},[]);return a.jsxs(y,{sx:{width:"75%",position:"relative",display:"flex"},children:[a.jsx(x,{style:{},...o,selectedTabIndex:c,tabNames:S,onSelectedTabIndexChange:m,onTabNameChange:u,onTabMove:b,background:"white",activeColor:null,createScrollStartButton:T,createScrollEndButton:I,createScrollEdgeButton:g,createTabButton:e=>a.jsx(C,{...e}),editLabelProps:{styleHover:{fontWeight:"700"}},children:a.jsx(v,{style:{padding:"0px",margin:"0px 0px",border:"none"},dense:!0,outlined:!1,color:"primary","aria-label":"menu",icon:a.jsx(f,{})})}),a.jsx("div",{style:{minWidth:"4px"}}),a.jsx(w,{disabled:h.disabled,sx:{padding:"0",height:"24px","&:hover:not([disabled])":{color:e=>e.palette.primary.main}},"aria-label":"addTab",size:"small",children:a.jsx(B,{})})]})},n=N.bind({});n.args={disabled:!1};n.storyName="TabStrip with MUI";const A={title:"TabStrip",component:n};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`props => {
  const {
    ...rest
  } = props as any;
...
}`,...n.parameters?.docs?.source}}};const H=["TabStripMUI"];export{n as TabStripMUI,H as __namedExportsOrder,A as default};
