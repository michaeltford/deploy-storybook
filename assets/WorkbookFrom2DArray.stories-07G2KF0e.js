import{j as u}from"./index-DjHwRWfA.js";import{r as a}from"./iframe-BjEmcQsQ.js";import{w as i,g as p}from"./index-DFFNLwEW.js";import{X as w}from"./index-Bu91P29L.js";import"./index-DrTFDFai.js";import"./preload-helper-D9Z9MdNV.js";import"./index-BAF_6BbL.js";import"./client-BRZzXANe.js";import"./index-Qdaqq9Ty.js";import"./TextField-6ZLHcmH7.js";import"./Tooltip-CSAwqu_I.js";const d=m=>{const{maxColumns:t,maxRows:s,...l}=m,b=a.useMemo(()=>{const e=new i({createSheetCallback:r=>new p({...r,maxRows:s,maxColumns:t})});return e.getSelectedSheet().getRange("A1:C3").setValues([[1,2,3],[4,5,6],[7,8,9]]),e},[s,t]),c={border:"blue solid 2px",borderRadius:"8px",flex:"1 1 100%",minHeight:"460px"},n=a.useRef(null);return u.jsx(w,{sx:c,ref:n,onElementLoad:e=>{const r=n.current,k=e.source;r.getWorkbook(),k.getWorkbook()},...l,workbook:b,title:"From 2D Array"})},o=d.bind({});o.args={maxRows:100,maxColumns:20};o.storyName="From 2D Array";const F={title:"Models/From 2D Array",component:o};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`props => {
  const {
    maxColumns,
    maxRows,
    ...rest
