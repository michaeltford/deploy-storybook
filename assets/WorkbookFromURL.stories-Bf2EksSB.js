import{j as o}from"./index-Bex5ZTIz.js";import{r as s}from"./iframe-Bhn-vlEr.js";import{t as b,A as w}from"./index-9kA3aVAG.js";import{B as p}from"./TextField-CibThDkM.js";import"./index-CQih4H26.js";import"./preload-helper-D9Z9MdNV.js";import"./index-tI__wt30.js";import"./client-BiiePqMP.js";import"./index-CpiIqDFN.js";import"./index-Bl98VB8F.js";import"./Tooltip-BCGaakb4.js";const y=u=>{const{...c}=u,k={source:null},[t,h]=s.useState("https://www.sheetxl.com/examples/features-checklist.xlsx"),[l,m]=s.useState(null),[f,d]=s.useState(""),x=async i=>{const n=await fetch(t);if(!n.ok)throw`Unable to fetch: ${n.url}`;const r=await w.read({...k,source:{input:t},formatType:"xlsx"});return d(r.title),m(r.workbook),r.workbook},a={border:"blue solid 2px",borderRadius:"8px",flex:"1 1 100%"};return o.jsx(p,{sx:{minHeight:"560px",display:"flex",position:"relative"},children:l?o.jsx(o.Fragment,{children:o.jsx(b,{sx:{...a,position:"absolute"},...c,workbook:l,title:f})}):o.jsxs(p,{style:{padding:"8px 16px",display:"flex",flexDirection:"row",gap:"8px",alignItems:"start",...a},children:[o.jsx("input",{style:{minWidth:"360px"},name:"input-url",autoComplete:"off",value:t,onChange:i=>{h(i.target.value)}}),o.jsx("button",{onClick:x,children:"Fetch"})]})})},e=y.bind({});e.args={};e.storyName="From URL";const L={title:"Models/From URL",component:e};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`props => {
  const {
    ...rest
  } = props as any;
