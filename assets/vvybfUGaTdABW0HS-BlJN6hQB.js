const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./C9w2B1z_73Lcpp23-BVZSPR7l.js","./preload-helper-PPVm8Dsz.js","./index-C4mmmnnj.js","./index-fWxn02CS.js","./index-DWKpDUR-.js","./iframe-CpXbX42E.js","./index-z4VAroti.js","./client-Ba8_ROJ4.js","./index-C3bn2QFg.js"])))=>i.map(i=>d[i]);
 ...
 * @license @sheetxl/primitives - Primitives - Base types for SheetXL functions. - v0.7.7
 *
...
var Re, ie, d;
(ie = Re || (Re = {})).Orientation = { Column: "column", Row: "row" }, ie.Orientations = { ...ie.Orientation, Both: "both" }, ie.Direction = { Up: "up", Down: "down", Left: "left", Right: "right" }, ((e) => {
  ...
  class t extends Error {
    constructor(c, h, fe, B) {
      super(fe, B), this._label = h, this._code = c, this.details = B;
    }
    static {
  ...
  class n extends t {
    constructor(c, h) {
      super(e.Code.Parse, e.Label.Parse, c, h);
    }
    static {
  ...
  class r extends t {
    constructor(c, h) {
      super(e.Code.Null, e.Label.Null, c, h);
    }
    static {
  ...
  class o extends t {
    constructor(c, h) {
      super(e.Code.Div0, e.Label.Div0, c, h);
    }
    static {
  ...
  class a extends t {
    constructor(c, h) {
      super(e.Code.Value, e.Label.Value, c, h);
    }
    static {
  ...
  class i extends t {
    constructor(c, h) {
      super(e.Code.Ref, e.Label.Ref, c, h);
    }
    static {
  ...
  class l extends t {
    constructor(c, h) {
      super(e.Code.Name, e.Label.Name, c, h);
    }
    static {
  ...
  class u extends t {
    constructor(c, h) {
      super(e.Code.Num, e.Label.Num, c, h);
    }
    static {
  ...
  class p extends t {
    constructor(c, h) {
      super(e.Code.NA, e.Label.NA, c, h);
    }
    static {
      this.code = e.Code.NA;
    }
  ...
  class w extends t {
    constructor(c, h) {
      super(e.Code.GettingData, e.Label.GettingData, c, h);
    }
    static {
  ...
  class g extends t {
    constructor(c, h) {
      super(e.Code.Spill, e.Label.Spill, c, h);
    }
    static {
  ...
  class f extends t {
    constructor(c, h) {
      super(e.Code.Connect, e.Label.Connect, c, h);
    }
    static {
  ...
  class y extends t {
    constructor(c, h) {
      super(e.Code.Blocked, e.Label.Blocked, c, h);
    }
    static {
  ...
  class x extends t {
    constructor(c, h) {
      super(e.Code.Unknown, e.Label.Unknown, c, h);
    }
    static {
      this.code = e.Code.Unknown;
    }
  ...
  class A extends t {
    constructor(c, h) {
      super(e.Code.Field, e.Label.Field, c, h);
    }
    static {
  ...
  class D extends t {
    constructor(c, h) {
      super(e.Code.Calc, e.Label.Calc, c, h);
    }
    static {
  ...
  class U extends t {
    constructor(c, h) {
      super(e.Code.Busy, e.Label.Busy, c, h);
    }
    static {
  ...
  class I extends t {
    constructor(c, h) {
      super(e.Code.Python, e.Label.Python, c, h);
    }
    static {
  ...
  class J extends t {
    constructor(c, h) {
      super(e.Code.Timeout, e.Label.Timeout, c, h);
    }
    static {
...
var T;
(T = d || (d = {})).BuiltIn = { Parse: new T.Parse(), Null: new T.Null(), Div0: new T.Div0(), Value: new T.Value(), Ref: new T.Ref(), Name: new T.Name(), Num: new T.Num(), NA: new T.NA(), GettingData: new T.GettingData(), Spill: new T.Spill(), Connect: new T.Connect(), Blocked: new T.Blocked(), Unknown: new T.Unknown(), Field: new T.Field(), Calc: new T.Calc(), Busy: new T.Busy(), Python: new T.Python(), Timeout: new T.Timeout() }, T.getBuiltInByLabel = (e) => nt.get(e), T.newTypedError = (e, t, n) => {
  let r;
  return r = typeof e == "string" ? rt.get(e) : ot.get(e), r || (r = T.Unknown), new r(t, n);
}, T.getBuiltInById = (e) => Te.get(e) || xt;
/**
 * @license @sheetxl/utils - Utils - Utilities used by most SheetXL components. - v0.7.7
 *
 * (C) 2025-present SheetXL Inc. & Michael T. Ford
 * License: The license can be found at https://www.sheetxl.com/license.
 */
const j = { Column: "column", Row: "row" }, Ct = Object.freeze({ colIndex: 0, rowIndex: 0 }), vt = Object.freeze({ colStart: 0, rowStart: 0, colEnd: 0, rowEnd: 0 }), at = (e, t) => e.colStart === t.colStart ? e.rowStart - t.rowStart : e.colStart - t.colStart, it = (e, t) => e.rowStart === t.rowStart ? e.colStart - t.colStart : e.rowStart - t.rowStart, Tt = (e, t) => e.rowEnd === t.rowEnd ? t.colEnd - e.colEnd : t.rowEnd - e.rowEnd, _t = (e, t) => e.colEnd === t.colEnd ? t.rowEnd - e.rowEnd : t.colEnd - e.colEnd, Le = (e, t) => e.colIndex === t.colIndex ? e.rowIndex - t.rowIndex : e.colIndex - t.colIndex, Ae = (e, t) => e.rowIndex === t.rowIndex ? e.colIndex - t.colIndex : e.rowIndex - t.rowIndex, Me = (e, t) => e.rowIndex === t.rowIndex ? t.colIndex - e.colIndex : t.rowIndex - e.rowIndex, je = (e, t) => e.colIndex === t.colIndex ? t.rowIndex - e.rowIndex : t.colIndex - e.colIndex, lt = (e = j.Row, t = !1) => t ? e !== j.Column ? Tt : _t : e !== j.Column ? it : at, Pe = (e, t) => e === t || !(!e || !t) && e.rowIndex === t.rowIndex && e.colIndex === t.colIndex, Se = (e, t) => e === t || !(!e || !t) && e.rowStart === t.rowStart && e.rowEnd === t.rowEnd && e.colStart === t.colStart && e.colEnd === t.colEnd, xe = (e, t) => !(!e || !t) && !(e.colStart > t.colEnd || t.colStart > e.colEnd) && !(e.rowStart > t.rowEnd || t.rowStart > e.rowEnd), Fe = (e, t) => {
  if (e === t) return !0;
  ...
  return n;
}, Ot = [null, null], It = (e, t, n) => {
  if (e[0].value === e[1].value) return t;
};
function Ue(e, t = 2, n, r = j.Row, o) {
  let a = [...e];
  if (t <= 0 || e.length <= 1) return a;
  let i = r === j.Column, l = 0, u = !1;
  do {
    const p = a.sort(lt(i ? j.Row : j.Column));
    a = [], a.push(p[0]);
    const w = p.length;
    let g = 0, f = p[0], y = f.colStart, x = f.rowStart, A = f.colEnd, D = f.rowEnd;
    for (let U = 1; U < w; U++) {
      const I = p[U];
      let J = !1;
      if (J = i ? f && x === I.rowStart && D === I.rowEnd && A + 1 === I.colStart : f && y === I.colStart && A === I.colEnd && D + 1 === I.rowStart, J) {
        let E = { colStart: y, rowStart: x, colEnd: i ? I.colEnd : A, rowEnd: i ? D : I.rowEnd };
        if (f.value !== void 0 && (E.value = f.value), n) {
          const c = o ?? [null, null];
          c[0] = f, c[1] = I, E = n(c, E, r);
        }
        if (E) {
          a[g] = E, u = !0, f = E, y = f.colStart, x = f.rowStart, A = f.colEnd, D = f.rowEnd;
          continue;
        }
      }
      a[++g] = I, f = I, y = f.colStart, x = f.rowStart, A = f.colEnd, D = f.rowEnd;
    }
    l++, i = !i, l === 1 && (u = !0);
  } while (l < t && u && a.length > 1);
  return a;
}
Object.freeze(Object.defineProperty({ __proto__: null, EmptyCell: Ct, EmptyRange: vt, cellToRange: (e, t) => {
  if (!e) return null;
  let n = t;
...
}, columnFirstCellComparator: Le, columnFirstRangeComparator: at, createCellComparator: (e = j.Row, t = !1) => t ? e !== j.Column ? Me : je : e !== j.Column ? Ae : Le, createConflatingRanges: (e, t = !1) => {
  const n = [];
  ...
  return { append: (l, u, p) => {
    ...
    if (w && u === i + 1 && l === a) return t ? r.rowEnd = u : r.colEnd = u, i = u, void (o = p);
    r && n.push(r);
    const f = t ? l : u, y = t ? u : l;
    r = { colStart: f, rowStart: y, colEnd: f, rowEnd: y }, g && (r.value = p), a = l, i = u, o = p;
  }, done: (l) => (r && (n.push(r), r = null), l ? Ue(n, 3, l === !0 ? It : l, t ? j.Column : j.Row, Ot) : n) };
...
function Pt(e, t, n) {
  ...
  return n.isMergeableObject(e) && Be(e).forEach(function(o) {
    ...
    (function(a, i) {
      return $e(a, i) && !(Object.hasOwnProperty.call(a, i) && Object.propertyIsEnumerable.call(a, i));
    })(e, o) || ($e(e, o) && n.isMergeableObject(t[o]) ? r[o] = (function(a, i) {
...
const Ft = Object.freeze([]), Dt = Object.freeze({}), ze = (e) => e, de = () => "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(e) {
  ...
  for (let a = 0; a < r.length; a++) {
    const i = r[a];
    ut(e[i], t?.[i], n) === null && (o = !0, delete e[i]);
  }
  return o && Object.keys(e).length === 0 ? null : void 0;
}, Ke = typeof performance == "object" && typeof performance.now == "function" ? () => performance.now() : () => Date.now(), Ve = (e) => e == null, Ge = (e, t) => !(t.left > e.right || t.right < e.left || t.top > e.bottom || t.bottom < e.top), qe = !(typeof window > "u" || !window.document || !window.document.createElement), k = { Windows: "windows", MacOS: "macos", IOS: "ios", Linux: "linux", Android: "android", Safari: "safari", Firefox: "firefox", Node: "node", Unknown: "unknown" }, oe = () => {
  if (dt()) return k.Node;
...
const We = (e, t = !1) => (document.hasFocus() || t) && (e === document.activeElement || e?.contains(document.activeElement)), $t = Object.freeze(Object.defineProperty({ __proto__: null, EmptyArray: Ft, EmptyObject: Dt, OSType: k, arrayMove: function(e, t, n) {
...
}).trim(), canUseDOM: qe, cancelTimeout: (e) => {
  ...
  function u() {
    let w = Date.now() - l;
    w < t && w >= 0 ? r = setTimeout(u, t - w) : (r = null, n || (i = e.apply(a, o), a = o = null));
  }
  t == null && (t = 100);
  const p = function() {
    a = globalThis, o = arguments, l = Date.now();
    var w = n && !r;
    return r || (r = setTimeout(u, t)), w && (i = e.apply(a, o), a = o = null), i;
  };
  ...
  for (let a = 0; a < o; a++) {
    const i = r[a];
    e[i] !== t[i] && (e[i] === void 0 ? n[i] = t[i] : n[i] = e[i]);
  }
  ...
  for (let o = 0; o < n.length; o++) {
    ...
    if (!r) return null;
    let i = r[a];
    if (typeof i == "function" && (i = i.bind(r)()), !i || !ne(i)) return i;
    r = i;
  }
  return r ?? null;
...
}, isObject: ne, isPromiseLike: (e) => !!e && typeof e.then == "function", isRectInsideRect: (e, t) => e.top >= t.top && e.bottom <= t.bottom && e.left >= t.left && e.right <= t.right, isRectIntersect: Ge, mergeContentful: (...e) => {
  const t = e.length;
  ...
  if (!qe) return void n("Unable to open dialog with no dom.");
  ...
  for (let a = 0; o && a < r.length - 1; a++) {
    const i = r[a];
    let l = o[i];
    if (l == null && (l = {}, o[i] = l), !ne(l)) throw new Error("Can not set path to a non object path.");
    o = l;
  }
...
const pt = "data:image/png;base64,", ht = "Unable to resolve image.", Ye = (e) => new Promise(async (t, n) => {
  let r = null;
  try {
...
Object.freeze(Object.defineProperty({ __proto__: null, DATA_URL_PNG_PREFIX: pt, getImageDataUrl: (e, t = 1) => new Promise(async (n, r) => {
  ...
  const r = async () => {
    try {
      const a = t ?? "image/*", i = URL.createObjectURL(new Blob([e], { type: a })), l = await Ye(i);
      n = { mimeType: a, naturalSize: l, asUrl: i };
    } catch {
    }
  }, o = async () => {
    try {
      const a = new TextDecoder().decode(e), i = URL.createObjectURL(new Blob([a], { type: we })), l = await Ye(i);
      n = { mimeType: t ?? we, naturalSize: l, asUrl: i, asSVGText: a };
    } catch {
    }
  };
...
(He = Je || (Je = {})).resolveTypedUpdates = (e, t, n, r) => {
  ...
  if (t && t.merge && l && r) l = t.merge(l, r, n);
    ...
    for (let w = 0; w < p; w++) {
      ...
      if (y !== void 0) {
        const x = a[g];
        f = x ? (0, He.resolveTypedUpdates)(y, x, n, r?.[g]) : y;
      } else f = r?.[g];
      f != null && (l = l ?? {}, l[g] = f);
    }
  }
...
All copy and paste operations will be limited to the browser tab.\`, mt = { Safari: \`The Safari browser does not support advanced copy and paste.
Copy and paste will be limited to within the browser tab.
...
Please use Chrome or Edge if external copy and paste is required.\`, Perms: ye, PermsWrite: oe() === k.Safari ? Xe : ye, PermsRead: oe() === k.Safari ? Xe : ye }, ge = async () => new Promise((e) => {
  ...
  if (oe() === k.Safari) return await n(new Error(mt.Safari));
  try {
    const r = async (i) => {
      try {
        return await i();
...
const ve = async (e, t = S.html) => new Promise(async (n, r) => {
  ...
  e && await e.writeText("");
}, ae = "clipboard-uuid", Q = "web text/uuid", Qe = (e) => \`<div style="display:none" \${ae}="\${e}"/>\`, Vt = (e, t) => {
  let n = null;
  try {
...
class tt {
  ...
  async _write(t) {
    ...
    await be("clipboard-write", async () => {
      await ge(), o && a.length === 0 && (a.push(new ClipboardItem({ [Q]: new Blob([o], { type: Q }) })), a.push(new ClipboardItem({ [S.html]: new Blob([Qe(o)], { type: S.html }) })));
      for (let l = 0; l < Math.min(1, a.length); l++) {
        const u = a[l];
        let p = u.types.indexOf(S.html), w = null;
        if (p !== -1) {
          const y = await u.getType(S.html);
          w = await Ce(y), w && (w = Vt(o, w));
        }
        if (!w && u.types.includes(S.plain)) {
          const y = await u.getType(S.plain);
          if (y) {
            let x = null;
            typeof y == "string" ? (console.warn("text as string", y), x = y) : x = await Ce(y), x && (w = \`<div \${ae}="\${o}">\${x}</div>\`);
          }
        }
        if (!w && u.types.includes(S.png)) {
          const y = await u.getType(S.png), x = ft(await y.arrayBuffer());
          w = \`<div \${ae}="\${o}"><img src="\${pt + x}"/></div>\`;
        }
        !w && o && (w = Qe(o));
        const g = new Blob([w ?? ""], { type: S.html }), f = {};
        for (let y = 0; y < u.types.length; y++) {
          const x = u.types[y];
          f[x] = y === p ? g : u.getType(x);
        }
...
var Ee;
(Ee = tt || (tt = {})).ErrorMessages = mt, Ee.Global = new Ee();
const Gt = "__SHEETXL";
let ee = null, le = null;
async function qt() {
  if (ee)
...
async function Yt(e, t, n = "/script.js", r = Gt) {
  try {
    const o = await qt(), a = "@sheetxl/primitives", i = \`
    ...
    throw u.errors && u.errors.length > 0 ? new Error(\`esbuild bundling failed: \${u.errors.map((p) => p.text).join(\`
...
async function nn(e) {
  ...
  const p = [], w = {
    ...
    getSourceFile: (s, m, L, P) => i.createSourceFile(s, A[s], i.ScriptTarget.Latest, !0),
    ...
    getNewLine: () => \`
\`
  }, U = i.createProgram([f, x], w, D), I = U.getTypeChecker(), J = U.getSourceFile(f), E = U.emit();
  E.diagnostics.length > 0 && console.warn(E.diagnostics), l = A[\`\${g}.js\`];
  const c = (s, m, L, P) => {
    if (!s) {
      $(s, new Error(\`Type is not defined for '\${m?.name ?? "return"}'.\`));
      return;
    }
    if (s.kind === i.SyntaxKind.NumberKeyword)
      m.scalar = W.Number;
    else if (s.kind === i.SyntaxKind.StringKeyword)
      m.scalar = W.String;
    else if (s.kind === i.SyntaxKind.BooleanKeyword)
      m.scalar = W.Boolean;
    else if (s.kind === i.SyntaxKind.UndefinedKeyword || s.kind === i.SyntaxKind.NullKeyword || s.kind === i.SyntaxKind.VoidKeyword) {
      if (P) {
        $(s, new Error(\`'undefined' is not a valid type for input: '\${s?.parent?.name?.escapedText}'.\`));
        return;
      }
      m.scalar = W.Null;
    } else if (s.kind === i.SyntaxKind.BigIntKeyword)
      m.scalar = W.Number;
    else if (s.kind === i.SyntaxKind.AnyKeyword)
      m.scalar = W.Null;
    else if (s.kind === i.SyntaxKind.ArrayType) {
      const M = s.elementType;
      if (!M) {
        $(s, new Error(\`'Array' must be typed: '\${s?.parent?.name?.escapedText}'.\`));
        return;
      }
      m.arrayDepth = (m.arrayDepth ?? 0) + 1, c(M, m, L, P);
    } else if (s.kind !== i.SyntaxKind.TupleType) {
      if (s.kind === i.SyntaxKind.TypeReference) {
        const M = s.typeName?.getText?.() ?? null, K = yt.get(M);
        let V = !1;
        K && (m.range = K, V = !0);
        const G = Zt.get(M);
        if (G && (m.scalar = G), G !== void 0 && (V = !0), P) {
          const R = gt.get(M);
          if (R)
            return R;
        } else {
  ...
  }, h = (s) => (i.getCombinedModifierFlags(s) & i.ModifierFlags.Export) !== 0, fe = (s) => (i.getCombinedModifierFlags(s) & i.ModifierFlags.Default) !== 0, B = [], $ = (s, m) => {
    B.push(m);
  };
  if (i.forEachChild(J, (s) => {
    if (h(s) && i.isFunctionDeclaration(s)) {
      const m = {}, L = {
        parameters: {}
      }, P = s?.name?.getText();
      try {
        ...
        const V = {};
        c(s.type, V, m, !1), m.returnType = V;
        const G = {};
        fe(s) && (G.default = !0, u = P), Object.keys(G).length > 0 && (m.behavior = G), m.parameters = [];
        const H = /* @__PURE__ */ new Map();
        for (let R = 0; R < s.parameters.length; R++) {
          const b = s.parameters[R], N = {};
          N.name = b.name?.getText();
          const X = c(b.type, N, m, !0);
          if (X) {
            if (m.parameters.length !== 0) {
              const F = s?.parent?.name?.getText();
              $(s, new Error(\`'\${m.name}' contexts must be the first parameter: '\${F}'.\`));
              return;
            }
            m.context = X;
            continue;
          ...
          if (z && (N.optional = !0, b.initializer))
            try {
              b.initializer.kind === i.SyntaxKind.StringLiteral ? v = b.initializer.text : b.initializer.kind === i.SyntaxKind.NumericLiteral ? v = parseFloat(b.initializer.text) : b.initializer.kind === i.SyntaxKind.TrueKeyword || b.initializer.kind === i.SyntaxKind.FalseKeyword ? v = b.initializer.kind === i.SyntaxKind.TrueKeyword : b.initializer.kind === i.SyntaxKind.NullKeyword ? v = null : b.initializer.kind === i.SyntaxKind.ObjectLiteralExpression || b.initializer.kind === i.SyntaxKind.ArrayLiteralExpression ? v = b.initializer.getText() : v = b.initializer.getText?.();
            } catch (O) {
              console.warn(\`Couldn't extract default value for parameter '\${N.name}'\`, O);
            }
          b.dotDotDotToken && (N.rest = !0), m.parameters.push(N);
          const C = { description: "" };
          L.parameters[N.name] = C;
          const q = I.getSymbolAtLocation(b.name).getDocumentationComment(I);
          q && q.length > 0 && q[0].text && (C.description = q[0].text), v !== void 0 && (C.defaultValue = v), H.set(N.name, N);
        }
          ...
          for (let b = 0; b < R.length; b++) {
            ...
            if (N)
              for (let X = 0; X < N.length; X++) {
                const z = N[X];
                let v = z?.tagName?.text;
                if (!v) continue;
                v = v.toLowerCase();
                let C = z.comment;
                const q = v === "hidden";
                if (!(typeof C != "string" && !q) && (typeof C == "string" && (C = C.replace(/[\\r\\n]+/g, "\\\\n").trim()), !(!q && C && (C = C.split(/\\\\n/)[0], !C || C.length === 0)))) {
                  if (C && typeof C == "string") {
                    const O = /\\{@link(code|plain)?\\s+([^}|]+)(?:\\s*\\|\\s*([^}]+))?\\}/g;
                    let F, Z = C, te = [];
                    for (; (F = O.exec(C)) !== null; ) {
                      const [pe, he, Et, Ne] = F, St = [Et.trim()];
                      Ne && St.push(Ne.trim());
                    }
                    C = Z, te.length > 0 && v === "see" && (L.links || (L.links = []), L.links.push(...te));
                  }
                  if (v === "name") {
                    const O = C;
                    O !== P && (L.name = O);
                      ...
                      try {
                        ...
                        if (Z.kind === i.SyntaxKind.UnionType) {
                          ...
                          F.enums = te, Z.types.forEach((pe) => {
                            if (pe.kind === i.SyntaxKind.LiteralType) {
                              const he = pe.literal.text;
                              he && te.push(he);
                            }
                          });
                        }
                    ...
                    F === "false" ? O = !1 : F !== "true" && (O = C), O !== !1 && (L.hidden = O ?? !0);
                  }
                }
              }
          }
